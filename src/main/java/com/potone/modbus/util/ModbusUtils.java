package com.potone.modbus.util;
...
public class ModbusUtils {
    ...
    public static byte[] hexStringToByteArray(String hexString) {
        String str = hexString.replaceAll(" ", "");
        int len = str.length();
    ...
    public static void main(String[] args) {
        byte[][] bs = new byte[][]{
                new byte[]{(byte) 0x55, (byte) 0x04, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01},
                new byte[]{(byte) 0x56, (byte) 0x04, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01},
                new byte[]{(byte) 0x57, (byte) 0x04, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01},
                new byte[]{(byte) 0x55, (byte) 0x06, (byte) 0x00, (byte) 0x00, (byte) 0x22, (byte) 0x60},
                new byte[]{(byte) 0x56, (byte) 0x06, (byte) 0x00, (byte) 0x00, (byte) 0x22, (byte) 0x60},
                new byte[]{(byte) 0x57, (byte) 0x06, (byte) 0x00, (byte) 0x00, (byte) 0x0F, (byte) 0xA0}
        };
        for (int i = 0; i < bs.length; i++) {
            String crc = getCRC3(bs[i]);
            System.out.println((bytes2HexString(bs[i]) + crc).replace(" ", ""));
        }
    }
